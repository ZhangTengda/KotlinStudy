package com.roger.kotlinstudy.SlidingMisalignment
...
import com.roger.kotlinstudy.SlidingMisalignment.adapter.*
import kotlinx.android.synthetic.main.activity_map_scroll.*
import android.view.Window.FEATURE_NO_TITLE
import com.roger.kotlinstudy.R
import com.roger.kotlinstudy.SlidingMisalignment.adapter.BgAdapter
import com.roger.kotlinstudy.SlidingMisalignment.adapter.LineAdapter
import com.roger.kotlinstudy.SlidingMisalignment.adapter.WorkAdapter
import com.roger.kotlinstudy.SlidingMisalignment.data.LessonStatusInfo
import com.roger.kotlinstudy.addOnScrollListener
import com.roger.kotlinstudy.dp2px
import com.roger.kotlinstudy.trueLet


/**
 * @Author: CoderPig
 *
 * https://juejin.im/post/5dc407516fb9a04ab462a166 -- 上
 *
 * https://juejin.im/post/5dcfc3e0e51d453daa0e422d -- 中
 *
 * https://juejin.im/post/5ddd55426fb9a071a929d528 -- 下
 * @Description:
